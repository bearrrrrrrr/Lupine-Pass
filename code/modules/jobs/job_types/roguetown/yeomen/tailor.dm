/datum/job/roguetown/tailor
	...
	faction = "Station"
	tutorial = "You were the hamlet’s tailor for as long as you could remember.  The influx of people has left you busy, mostly with repairs of travel clothes and leather armors."
	total_positions = 1
	spawn_positions = 1
	display_order = 6
	min_pq = 0
